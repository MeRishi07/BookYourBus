...
import { UserAllbusdetailsComponent } from './user-allbusdetails/user-allbusdetails.component';
...
@NgModule({
  declarations: [
    ...
    ViewAllBusDetailsComponent, UpdateBusComponent, AddPassengersComponent, UpdatePassengerComponent, PageNotFoundComponent, HomeComponent, UserModificationComponent, UserAllbusdetailsComponent
  ],
