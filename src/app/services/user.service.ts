...
export class UserService {
  ...
  */
  ...
  /* ---method to add user/ remove user---- */
  ...
  deleteUser(userId) {
    ...
    return this.http.post(`${this.baseUrl}/deleteUser/${userId}`, this.options).pipe(
      catchError(this.errorHandler)
    );
  }
  ...
  getAllLocations(): Observable<Location[]> {
    return this.http.get<Location[]>(`${this.baseUrl}/getLocations`).pipe(
      catchError(this.errorHandler)
    );
  }
}
